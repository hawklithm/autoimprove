...
async function configureClaudeMd(storageDir, claudeDir, templatesDir) {
    ...
    const guidanceTemplate = (0, path_1.join)(templatesDir, 'claude-guidance-template.md');
    if ((0, fs_1.existsSync)(guidanceTemplate)) {
        const guidance = (0, fs_1.readFileSync)(guidanceTemplate, 'utf-8').trim();
